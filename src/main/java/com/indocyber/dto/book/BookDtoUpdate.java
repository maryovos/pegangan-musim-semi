...
public class BookDtoUpdate {
    ...
    public BookDtoUpdate(String code, String title, Boolean isBorrowed, Category categoryName, Author author, String summary, LocalDate releaseDate, Integer totalPage) {
        this.code = code;
        this.title = title;
